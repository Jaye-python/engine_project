...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-&#h&4=-@ik!-ly!8$3bg4le^mm1(t!h*r0mak19u=b)1d_#^*5")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Django Rule Engine API",
    "DESCRIPTION": "A pluggable rule engine for order validation",
    "VERSION": "1.0.0",
